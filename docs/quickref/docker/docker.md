...
$ docker save -o /myimage.tar myimage:latest # 导出
$ docker load -i /myimage.tar # 导入
```
...
`docker service inspect --pretty `      | 显示详细信息服务
`docker service ls`                                   | 列出服务
`docker service ps`                                   | 列出服务的任务
`docker service scale =`       | 规模特殊服务
`docker service update  `      | 更新服务选项
