...
启动后，通过浏览器访问 `http://:61208` 查看系统监控数据。
...
- 在 Windows XP 上，%APPDATA% 为：`C:\Documents and Settings\\Application Data`
- 在 Windows Vista 及更高版本上：`C:\Users\\AppData\Roaming`
