...
- [Twitter 官网](https://twitter.com)
- [Twitter 的高级搜索](https://twitter.com/search-advanced)
...
搜索词 | 搜索结果
---|---
`关键字+min_faves:10` | 超过 10 个**`点赞`**有关相应关键字的推文；
`关键字+min_replies:9` | 超过 9 个**`回复`**有关相应关键字的推文；
`关键字+min_retweets:11` | 超过 11 个**`转发`**有关相应关键字的推文；
