...
<code>true</code> | **null** | **null** | <code>true</code> | **null** | false
false | <code>true</code> | false | <code>true</code> | <code>true</code> | <code>true</code>
false | false | false | false | false | <code>true</code>
false | **null** | false | **null** | **null** | <code>true</code>
**null** | <code>true</code> | **null** | <code>true</code> | **null** | **null**
...
```cs
// 创建一个字符串类型的HashSet
HashSet words = new HashSet { "apple", "banana" };
...
```cs
// 创建一个并发安全的整数集合
ConcurrentBag concurrentNumbers = new ConcurrentBag();
...
{
    public static IEnumerable CustomFilter(this IEnumerable source, Func<T, bool> predicate)
    {
